...
public class UpdatePostRequest {
  ...
  private Map<String, List<Waypoint>> waypoints;
  ...
  public UpdatePostRequest(List<String> resourcepacks, List<String> incompatible_resourcepacks,
      List<ServerInfo> servers, Map<String, List<Waypoint>> waypoints,
  ...
  public List<String> getResourcepacks() { return resourcepacks; }
  public void setResourcepacks(List<String> resourcepacks) { this.resourcepacks = resourcepacks; }

  public List<String> getIncompatibleResourcepacks() { return incompatible_resourcepacks; }
  ...
  public Map<String, List<Waypoint>> getWaypoints() { return waypoints; }
  public void setWaypoints(Map<String, List<Waypoint>> waypoints) { this.waypoints = waypoints; }

  public Map<String, FileInfo> getFiles() { return files; }
  public void setFiles(Map<String, FileInfo> files) { this.files = files; }
}